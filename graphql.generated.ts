...
export type GetProjectDataQueryQueryVariables = Exact<{
  organization: Scalars['String'];
  repository: Scalars['String'];
  projectNumber: Scalars['Int'];
  projectNextNumber: Scalars['Int'];
}>;


export type GetProjectDataQueryQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', projectNext?: { __typename?: 'ProjectNext', id: string, title?: string | null | undefined, fields: { __typename?: 'ProjectNextFieldConnection', nodes?: Array<{ __typename?: 'ProjectNextField', id: string, name: string, settings?: string | null | undefined } | null | undefined> | null | undefined } } | null | undefined } | null | undefined, repository?: { __typename?: 'Repository', project?: { __typename?: 'Project', name: string, columns: { __typename?: 'ProjectColumnConnection', nodes?: Array<{ __typename?: 'ProjectColumn', name: string, cards: { __typename?: 'ProjectCardConnection', nodes?: Array<{ __typename?: 'ProjectCard', content?: { __typename: 'Issue', id: string, title: string, number: number } | { __typename: 'PullRequest', id: string, title: string, number: number } | null | undefined } | null | undefined> | null | undefined } } | null | undefined> | null | undefined } } | null | undefined } | null | undefined };
...
export type AddItemMutationMutation = { __typename?: 'Mutation', addProjectNextItem?: { __typename?: 'AddProjectNextItemPayload', projectNextItem?: { __typename?: 'ProjectNextItem', id: string } | null | undefined } | null | undefined };

export type UpdateItemStatusMutationMutationVariables = Exact<{
  projectId: Scalars['ID'];
  itemId: Scalars['ID'];
  statusFieldId: Scalars['ID'];
  value: Scalars['String'];
}>;


export type UpdateItemStatusMutationMutation = { __typename?: 'Mutation', updateProjectNextItemField?: { __typename?: 'UpdateProjectNextItemFieldPayload', clientMutationId?: string | null | undefined } | null | undefined };


export const GetProjectDataQuery = gql`
    query GetProjectDataQuery($organization: String!, $repository: String!, $projectNumber: Int!, $projectNextNumber: Int!) {
...
export const UpdateItemStatusMutation = gql`
    mutation UpdateItemStatusMutation($projectId: ID!, $itemId: ID!, $statusFieldId: ID!, $value: String!) {
  updateProjectNextItemField(
    input: {projectId: $projectId, itemId: $itemId, fieldId: $statusFieldId, value: $value}
  ) {
    clientMutationId
  }
}
...
export const GetProjectDataQueryDocument = gql`
    query GetProjectDataQuery($organization: String!, $repository: String!, $projectNumber: Int!, $projectNextNumber: Int!) {
  organization(login: $organization) {
    projectNext(number: $projectNextNumber) {
      id
...
export const AddItemMutationDocument = gql`
  ...
  addProjectNextItem(input: {projectId: $projectId, contentId: $contentId}) {
    ...
    `;
export const UpdateItemStatusMutationDocument = gql`
    mutation UpdateItemStatusMutation($projectId: ID!, $itemId: ID!, $statusFieldId: ID!, $value: String!) {
  updateProjectNextItemField(
    input: {projectId: $projectId, itemId: $itemId, fieldId: $statusFieldId, value: $value}
  ) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetProjectDataQuery(variables: GetProjectDataQueryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetProjectDataQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProjectDataQueryQuery>(GetProjectDataQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProjectDataQuery');
    },
    AddItemMutation(variables: AddItemMutationMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AddItemMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddItemMutationMutation>(AddItemMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AddItemMutation');
    },
    UpdateItemStatusMutation(variables: UpdateItemStatusMutationMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateItemStatusMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateItemStatusMutationMutation>(UpdateItemStatusMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateItemStatusMutation');
    }
  };
}
